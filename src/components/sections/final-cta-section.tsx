...
export function FinalCtaSection({ className }: FinalCtaSectionProps) {
  ...
  const secondaryCta = {
    ...
    href: "/contact", // Placeholder - Assuming link might be similar or updated later
  };
    ...
    >
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <ShinyButton
            className="bg-primary-foreground text-primary hover:bg-primary-foreground/90 shadow-lg" // Adjusted padding and text size to match Button size="lg"
          ...
          <ShimmerButton
            ...
            className="text-primary shadow-lg" // Text color is primary (Ruby), adjusted padding
          >
